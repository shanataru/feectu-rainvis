...
Shader "Custom/RainSurfaceSimulation"
{
	...
	//pass 1
	float4 frag_contact_ripple_1(v2f_customrendertexture i) : SV_Target
	{
		return float4(-0.01f, 0, 0, 0);
	}

	float4 frag_contact_ripple_2(v2f_customrendertexture i) : SV_Target
	{
		return float4(-0.08f, 0, 0, 0);
	}

		float4 frag_contact_ripple_3(v2f_customrendertexture i) : SV_Target
	{
		return float4(-0.15f, 0, 0, 0);
	}

		float4 frag_contact_ripple_4(v2f_customrendertexture i) : SV_Target
	{
		return float4(-0.35f, 0, 0, 0);
	}

		float4 frag_contact_ripple_5(v2f_customrendertexture i) : SV_Target
	{
		return float4(-0.65f, 0, 0, 0);
	}
		float4 frag_contact_ripple_6(v2f_customrendertexture i) : SV_Target
	{
		...
		SubShader
	{
			...
			Pass
		{
			...
			CGPROGRAM
			#pragma vertex CustomRenderTextureVertexShader
			#pragma fragment frag_contact_ripple_1
			ENDCG
		}
			...
			Pass
		{
			...
			CGPROGRAM
			#pragma vertex CustomRenderTextureVertexShader
			#pragma fragment frag_contact_ripple_2
			ENDCG
		}
			...
			Pass
		{
			...
			CGPROGRAM
			#pragma vertex CustomRenderTextureVertexShader
			#pragma fragment frag_contact_ripple_3
			ENDCG
		}
			...
			Pass
		{
			...
			CGPROGRAM
			#pragma vertex CustomRenderTextureVertexShader
			#pragma fragment frag_contact_ripple_4
			ENDCG
		}
			...
			Pass
		{
			...
			CGPROGRAM
			#pragma vertex CustomRenderTextureVertexShader
			#pragma fragment frag_contact_ripple_5
			ENDCG
		}
			...
			Pass
		{
			...
			CGPROGRAM
			#pragma vertex CustomRenderTextureVertexShader
			#pragma fragment frag_contact_ripple_6
			ENDCG
		}
	}
}